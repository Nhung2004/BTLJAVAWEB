        ...
        <div class="row">
            ...
            <div class="col-md-8 mb-4">
                ...
                <div class="card p-4 mb-4 shadow-sm">
                    <h4>Bạn đã là thành viên? <a href="#">Đăng nhập ngay</a></h4>
                </div>
                ...
                <div class="card p-4 mb-4 shadow-sm">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="atmBanking">
                            <img src="atm_logo.png" alt="ATM" class="payment-logo" /> ATM/Internet Banking
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="paymentMethod" id="creditCard" />
                        <label class="form-check-label" for="creditCard">
                            <img src="visa_logo.png" alt="Visa" class="payment-logo" /> Visa/Master/JCB
                        </label>
                    </div>
                </div>
