                ...
                <div class="col">
                    ...
                    <div class="breadcrumbs d-flex flex-row align-items-center">
                        <ul>
                            ...
                            <li><a href="${pageContext.request.contextPath}/Homepage/ChangePassword.jsp">
                                <i class="fa fa-angle-right" aria-hidden="true"></i> Change password
                            </a></li>
                        </ul>
                    </div>
                </div>
					    ...
					    <div class="card">
					        <div class="card-body">
					            ...
					            <form action="${pageContext.request.contextPath}/ManageChangePassWordClient" method="POST">
					                ...
					                <div class="row mb-3">
					                    <div class="col-sm-3"><h6 class="mb-0">Re-enter new password</h6></div>
					                    <div class="col-sm-9 text-secondary">
					                        <div class="input-container">
