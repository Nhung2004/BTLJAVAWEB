...
public class DangKy extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (baoloi.length() > 0) {
            ...
            KhachHang kh = new KhachHang(makhachhang, tendangnhap, matkhauMaHoa, hovaten, gioitinh, diachikhachhang,
                    diachinhanhang, diachimuahang, ngaySinhDate, dienthoai, email, false, role);
