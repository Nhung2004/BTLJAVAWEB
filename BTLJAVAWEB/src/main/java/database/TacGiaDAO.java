...
public class TacGiaDAO implements DAOinterface<TacGia> {
	...
	public static void main(String[] args) {
	    ...
	    TacGia newTacGia = new TacGia("TG07", "Nguyễn Văn A", Date.valueOf("1990-01-01"), "Tác giả nổi tiếng trong lĩnh vực văn học.");
...
//	    sanPhamList.add(new SanPham("SP09", "Sản phẩm 1", tacGia1, 2023, 300000, 250000, 200000, 10, theLoai1, "Tiếng Việt", "Mô tả sản phẩm 1"));
//	    sanPhamList.add(new SanPham("SP10", "Sản phẩm 2", tacGia1, 2023, 350000, 300000, 250000, 5, theLoai2, "Tiếng Việt", "Mô tả sản phẩm 2"));
//	    sanPhamList.add(new SanPham("SP11", "Sản phẩm 3", tacGia2, 2022, 400000, 350000, 300000, 8, theLoai1, "Tiếng Việt", "Mô tả sản phẩm 3"));
//
