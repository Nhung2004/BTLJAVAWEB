...
public class Product
{
	...
	{
		return "Product [idProduct=" + idProduct + ", nameProduct=" + nameProduct + ", imageProduct=" + imageProduct + ", priceProduct=" + priceProduct + ", title=" + title + ", descriptions=" + descriptions + ", quantity=" + quantity + "]"; // toString
	}
}
